...
describe("Transaction", () => {
  ...
  describe("outputMap", () => {
    ...
    it("outputs the reamining balance for the `senderWaller`", () => {
  ...
  describe("input", () => {
    ...
    it("sets the `address` to the `senderWaller` publikcKey", () => {
    ...
    describe("update()", () => {
      ...
      describe("and the amount is valid", () => {
        ...
        it("subtracts the amount from the orginal sender output amount", () => {
          expect(transaction.outputMap[senderWallet.publicKey]).toEqual(
